...
class BillApp:
    def __init__(self, root):
        ...
        items = [
            ...
            ("Paneer_Tikkas", 200), ("Hara_Bhara_Kebab", 190), ("Fish_Fingers", 230), ("Crispy_Corn", 180),
            ("Chicken_Curry_Rice", 300), ("Mutton_Curry_Rice", 350), ("Prawn_Curry_Rice", 300),
            ("Egg_Curry_Rice", 400), ("Fish_Curry_Rice", 340), ("Veg_Thali", 250), ("Egg_Biryani", 220),
            ("Butter_Naan", 45), ("Butter_Roti", 35), ("Cheese_Garlic_Naan", 80), ("Keema_Naan", 50),
            ("Lachha_Paratha", 55), ("Roomali_Roti", 40), ("Plain_Naan", 35),
            ("Channa_Masala", 160), ("Kadhai_Paneer", 240), ("Mutton_Chicken", 280), ("Mutton_Biryani", 320),
            ("Chicken_Biryani", 270), ("EggVeg_Biryani", 200), ("Palak_Paneer", 210), ("Chicken_Tikka_Masala", 260), ("Mix_Veg", 170),
            ("JeeraSteamed_Rice", 150), ("Water_Bottle", 20), ("SaltSweet_Lassi", 40),
            ("Juices", 80), ("Lemon_SodaWater", 45), ("Cold_Coffee", 90), ("Masala_Chai", 30), ("Virgin_Mojito", 100)
        ]
        ...
        def create_frame(x, y, title, items):
            ...
            F.place(x=x, y=y, width=325, height=240)
            for idx, name in enumerate(items):
                Label(F, text=name.replace('_', ' '), font=("Helvetica", 12), fg=text_fg, bg=bg_color).grid(row=idx, column=0, padx=5, pady=5)
                Entry(F, bd=5, bg=entry_bg, textvariable=self.vars[name]).grid(row=idx, column=1, ipady=2, ipadx=1)

        create_frame(5, 180, "Starters", ["Gobi_Manchurian", "Chilli_Chicken", "Chicken_Lollipop", "Paneer_Tikkas", "Hara_Bhara_Kebab", "Fish_Fingers", "Crispy_Corn"])
        create_frame(5, 440, "Specials", ["Chicken_Curry_Rice", "Mutton_Curry_Rice", "Prawn_Curry_Rice", "Egg_Curry_Rice", "Fish_Curry_Rice", "Veg_Thali", "Egg_Biryani"])
        create_frame(330, 180, "Breads", ["Butter_Naan", "Butter_Roti", "Cheese_Garlic_Naan", "Keema_Naan", "Lachha_Paratha", "Roomali_Roti", "Plain_Naan"])
        create_frame(330, 440, "Curries", ["Channa_Masala", "Kadhai_Paneer", "Mutton_Chicken", "Mutton_Biryani", "Palak_Paneer", "Chicken_Tikka_Masala", "Mix_Veg"])
        create_frame(655, 440, "Beverages", ["Water_Bottle", "SaltSweet_Lassi", "Juices", "Lemon_SodaWater", "Cold_Coffee", "Masala_Chai", "Virgin_Mojito"])
